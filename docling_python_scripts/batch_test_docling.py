...
output_folder = "docling_output_markdowns"  # Folder to save the Markdown outputs
...
# Generate a unique Run ID for the report
...
print(f"Batch processing complete! Report saved to {report_file_path}.")
